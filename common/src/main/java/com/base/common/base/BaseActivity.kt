...
abstract class BaseActivity<VB : ViewDataBinding> : AppCompatActivity() {
    ...
    fun replaceFragment(fragment: Fragment, resId: Int, isBackStack: Boolean = true) {
        val transition = supportFragmentManager.beginTransaction().setCustomAnimations(
        ...
        if (isBackStack) {
            transition.addToBackStack(fragment::class.simpleName)
        }
        transition.commit()
    }
